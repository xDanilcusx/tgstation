...
/obj/item/uplink/Initialize(mapload, owner, tc_amount = 5)
	. = ..()
...
// Multitool uplink
/obj/item/multitool/uplink/Initialize(mapload, owner, tc_amount = 5)
	. = ..()
	AddComponent(/datum/component/uplink, owner, FALSE, TRUE, null, tc_amount)

// Pen uplink
/obj/item/pen/uplink/Initialize(mapload, owner, tc_amount = 5)
	. = ..()
